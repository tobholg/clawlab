...
const handleCreateItem = async (data: { title: string; description?: string; category?: string; dueDate?: string; ownerId?: string | null; assigneeIds?: string[]; priority?: string; status?: string; itemType?: 'TASK' | 'WORKSTREAM'; agentMode?: 'PLAN' | 'EXECUTE' | 'COMPLETED' | null }) => {
  try {
