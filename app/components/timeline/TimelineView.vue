...
<template>
  <div class="timeline-container bg-white rounded-xl border border-gray-200 overflow-hidden flex flex-col">
      ...
      <div class="flex flex-shrink-0">
        ...
        >
          ...
          >
            ...
            <!-- Today marker -->
            <div
              class="absolute top-0 h-full w-0.5 bg-clawlab-500 z-20"
              :style="{ left: `${dateToPosition(today)}px` }"
            >
              <span class="absolute -top-0 left-1/2 -translate-x-1/2 text-[10px] font-bold text-clawlab-600 bg-clawlab-100 px-1.5 py-0.5 rounded whitespace-nowrap">
                TODAY
              </span>
            </div>
          </div>
            ...
            <div class="relative">
              ...
              <div class="absolute inset-0 pointer-events-none">
                <div
                  ...
                  :class="[
                    day.isToday ? 'border-clawlab-200 border-l-2' :
              ...
              >
                ...
                >
                  ...
                  <!-- Hover highlight -->
                  <div 
                    class="absolute inset-0 ring-2 ring-clawlab-500 ring-opacity-0 group-hover:ring-opacity-100 transition-all pointer-events-none"
                    :class="task.isSubtask ? 'rounded' : 'rounded-lg'"
                  />
                </div>
              </div>
    ...
    <div class="border-t border-gray-200 bg-gray-50 px-4 py-2 flex flex-wrap items-center gap-4 text-xs text-gray-500">
      ...
      <span class="flex items-center gap-1.5">
        <div class="w-0.5 h-3 bg-clawlab-500" />
        Today
      </span>
    </div>
  </div>
