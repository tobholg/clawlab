  ...
  <div class="min-h-screen bg-gray-50">
    ...
    <aside class="fixed inset-y-0 left-0 w-64 bg-white border-r border-gray-200 flex flex-col">
      ...
      <div class="flex items-center h-16 px-6 border-b border-gray-200 flex-shrink-0">
        <span class="text-xl font-bold text-ctx-600">Context</span>
      </div>
      ...
      <div class="p-4 border-t border-gray-200 flex-shrink-0">
        <button class="w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-gray-50">
          <div class="w-8 h-8 rounded-lg bg-ctx-100 flex items-center justify-center">
          ...
          <div class="flex-1 text-left">
            <div class="font-medium text-gray-900">Context</div>
        ...
        <div class="flex items-center gap-4">
          ...
          <div class="relative">
            ...
            <input 
              ...
              class="pl-9 pr-4 py-2 w-64 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-ctx-500 focus:border-transparent"
            />
          </div>

          <!-- User -->
          <button class="w-8 h-8 rounded-full bg-ctx-500 flex items-center justify-center">
